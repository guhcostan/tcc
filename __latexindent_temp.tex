...
\begin{figure}[H]
\centering
\caption{Consulta pública} %legenda
\includegraphics[scale=0.22]{consulta-pública}\\  % o 0.9 indica 90% do tamanho original
% pdfLaTeX aceita figuras no formato PNG, JPG ou PDF
% figuras vetoriais podem ser exportadas para eps e depois convertidas para pdf usando epstopdf
{\small Fonte: http://sistemas.semas.pa.gov.br/pra/consultapública/#/} %Fonte da imagem
\label{fig:exemplo} %rotulo para refencia
\end{figure}
...
Após ajudar com o começo do projeto e facilitar o desenvolvimento do mesmo, fui incorporado a uma equipe na mesma tribo e cuidava de alguns projetos como o SIOUT e SIGERH-PA.
